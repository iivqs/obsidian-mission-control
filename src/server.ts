...
// Tool stub handlers
import { startSession, endSession } from './tools/session';
import { getBriefing, listProjects, focusProject } from './tools/projects';
import { getTasks, updateTask, logDecision } from './tools/tasks';
import { query, readCanvas } from './tools/query';
